...
**The Fix:**
- **[One Sec](https://one-sec.app/)**: This app forces you to take a deep breath before opening a distracting app.
...
**The Fix:**
You don't need the app to use the chat.
- **Use an Aggregator:** Apps like **[Beeper](https://www.beeper.com/)** or **[Texts](https://texts.com/)** allow you to connect your Instagram Direct Messages to a single, clean inbox that has *zero* news feed. You get the connection without the addiction.
- **Feed Blockers:** If you must keep the app, tools like **[BeTimeFul](https://www.betimeful.com/)** or modified Android clients can strip the feed entirely, leaving only the functional parts.
